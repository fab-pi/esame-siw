...
public class TaskService {
    ...
    public List<Tag> getTags(long id) {
       return this.getTask(id).getTags();
    }
    
    @Transactional
    public List<Comments> getComments(long id) {
       return this.getTask(id).getComments();
    }
    ...
    @Transactional
    public Task saveTaskWithDelegated(Task task, User user) {
    	task.setDelegated(user);
        return this.taskRepository.save(task);
    }
    ...
    @Transactional
    public Task addCommentsToTask(Task task, Comments comments) {
    	task.addComments(comments);
        return this.taskRepository.save(task);
    }
    
    @Transactional
    public Task updateTask(Task task, Task task2) {
    ...
    @Transactional
    public Task updateTaskMember(Task task, Task task2) {
